...
execute if score Side RoundsToSwitch matches 1 run title @a title {"text":"Defenders Win","bold":true,"color":"dark_purple"}
execute if score Side RoundsToSwitch matches 2 run title @a title {"text":"Defenders Win","bold":true,"color":"yellow"}
