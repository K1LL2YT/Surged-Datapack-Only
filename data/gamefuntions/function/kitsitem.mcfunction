...
execute as @a[tag=healer,team=!Admin,team=!Owner] at @s run attribute @s generic.max_health base set 20
...
execute as @a[tag=sword,team=!Admin,team=!Owner] at @s run give @s stick[enchantments={levels:{"minecraft:sharpness":7}}] 1
...
execute as @a[tag=splasher,team=!Admin,team=!Owner] at @s run give @s splash_potion[item_name='{"bold":true,"color":"#b4ccb1","text":"Speed Potion"}',potion_contents={custom_color:12432564,custom_effects:[{id:"minecraft:speed",amplifier:0,duration:200}]}] 1
...
execute as @a[tag=engineer,team=!Admin,team=!Owner] at @s run attribute @s generic.max_health base set 20

## Juggernaunt
execute as @a[tag=jugg,team=!Admin,team=!Owner] at @s run give @s stick[enchantments={levels:{"minecraft:sharpness":3}}] 1
...
execute as @a[tag=jugg,team=!Admin,team=!Owner] at @s run item replace entity @s armor.chest with iron_chestplate[enchantments={levels:{"minecraft:projectile_protection":3}}]
execute as @a[tag=jugg,team=!Admin,team=!Owner] at @s run item replace entity @s armor.legs with iron_leggings[enchantments={levels:{"minecraft:projectile_protection":3}}]
execute as @a[tag=jugg,team=!Admin,team=!Owner] at @s run item replace entity @s armor.feet with iron_boots[enchantments={levels:{"minecraft:projectile_protection":3}}]
execute as @a[tag=jugg,team=!Admin,team=!Owner] at @s run attribute @s generic.max_health base set 14

## Ninja
execute as @a[tag=ninja,team=!Admin,team=!Owner] at @s run give @s stick[enchantments={levels:{"minecraft:sharpness":4}}] 1
execute as @a[tag=ninja,team=!Admin,team=!Owner] at @s run attribute @s generic.max_health base set 14
