...
execute as @a at @s if items entity @s[scores={sneaktime=1}] weapon.mainhand minecraft:carrot_on_a_stick if block ~ -46 ~ minecraft:red_terracotta unless block ~ ~-0.1 ~ air if entity @s[tag=engineer] run scoreboard players add @s planting 2
...
# Planting Timer
execute as @a[scores={planting=1..19}] at @s run title @s title {"text":"5s","bold":true,"color":"red"}
execute as @a[scores={planting=20..39}] at @s run title @s title {"text":"4s","bold":true,"color":"red"}
execute as @a[scores={planting=40..59}] at @s run title @s title {"text":"3s","bold":true,"color":"red"}
execute as @a[scores={planting=60..79}] at @s run title @s title {"text":"2s","bold":true,"color":"red"}
execute as @a[scores={planting=80..}] at @s run title @s title {"text":"1s","bold":true,"color":"red"}

execute as @a[scores={planting=1..19}] at @s run title @s times 0 1s 0.5s
execute as @a[scores={planting=20..39}] at @s run title @s times 0 1s 0.5s
execute as @a[scores={planting=40..59}] at @s run title @s times 0 1s 0.5s
execute as @a[scores={planting=60..79}] at @s run title @s times 0 1s 0.5s
