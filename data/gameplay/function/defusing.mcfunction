...
execute as @a at @s if items entity @s weapon.mainhand minecraft:shears at @e[type=armor_stand,distance=0..1.5,tag=bomb] if entity @s[tag=engineer] run scoreboard players add @s defusing 2
...
execute as @a[scores={defusing=20..39}] at @s run title @s title {"text":"6s","bold":true,"color":"red"}
execute as @a[scores={defusing=40..59}] at @s run title @s title {"text":"5s","bold":true,"color":"red"}
execute as @a[scores={defusing=60..79}] at @s run title @s title {"text":"4s","bold":true,"color":"red"}
execute as @a[scores={defusing=80..99}] at @s run title @s title {"text":"3s","bold":true,"color":"red"}
execute as @a[scores={defusing=100..119}] at @s run title @s title {"text":"2s","bold":true,"color":"red"}
execute as @a[scores={defusing=120..}] at @s run title @s title {"text":"1s","bold":true,"color":"red"}

execute as @a[scores={defusing=1..19}] at @s run title @s times 0 1s 0.5s
execute as @a[scores={defusing=20..39}] at @s run title @s times 0 1s 0.5s
execute as @a[scores={defusing=40..59}] at @s run title @s times 0 1s 0.5s
execute as @a[scores={defusing=60..79}] at @s run title @s times 0 1s 0.5s
execute as @a[scores={defusing=80..99}] at @s run title @s times 0 1s 0.5s
execute as @a[scores={defusing=100..119}] at @s run title @s times 0 1s 0.5s
