...
clear @a[team=!Admin,team=!Owner]
## Map 7
execute as @a[tag=attacker] if score mapselect mapselect matches 7 at @s run tp 54 -15 339
execute as @a[tag=defender] if score mapselect mapselect matches 7 at @s run tp 114 -15 393
clear @a[team=!Admin,team=!Owner]
...
## Map 7
execute if score mapselect mapselect matches 7 run fill 56 -13 341 52 -15 337 black_stained_glass replace minecraft:structure_void
execute if score mapselect mapselect matches 7 run fill 112 -13 391 116 -15 395 black_stained_glass replace minecraft:structure_void
