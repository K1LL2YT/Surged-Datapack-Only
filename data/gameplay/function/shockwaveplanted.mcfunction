...
execute as @a[tag=GamingGuyPack, team=attacker] at @s run function gamingvp:shockwaveatt
execute as @a[tag=GamingGuyPack, team=defender] at @s run function gamingvp:shockwavedef